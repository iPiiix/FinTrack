...
export function SettingsView() {
  ...
  return (
    <div className="w-full flex-1 flex flex-col items-center bg-[#09090B] overflow-y-auto">
      <div className="vu w-full max-w-[720px] px-6 py-12">
        ...
        <div style={{ border: "1px solid #1C1C1F", borderRadius: 6, overflow: "hidden", marginBottom: 24 }}>
          ...
          <div style={{ padding: "24px" }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div className="inp" style={{ opacity: 0.6, cursor: "not-allowed", background: "#0d0d0f", color: "#a1a1aa", border: "1px solid #27272a", padding: "11px 14px", borderRadius: "4px" }}>
